...
from MissCutie import HELP_COMMANDS, LOGGER
...
@Bot.on_message(command("disable") & can_change_filter)
...
@Bot.on_message(command("disabledel") & can_change_filter)
...
@Bot.on_message(command("enable") & can_change_filter)
...
@Bot.on_message(command("disableable") & can_change_filter)
...
@Bot.on_message(command("disabled") & admin_filter)
...
@Bot.on_message(command("enableall") & owner_filter)
...
@Bot.on_callback_query(filters.regex("^enableallcmds$"))
