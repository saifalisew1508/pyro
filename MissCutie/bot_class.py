...
from MissCutie.database import MongoDB
from MissCutie.plugins import all_plugins
from MissCutie.tr_engine import lang_dict
...
class Bot(Client):
    """Starts the Pyrogram Client on the Bot Token when we do 'python3 -m MissCutie'"""
