...
from MissCutie.utils.custom_filters import command, owner_filter, restrict_filter
from MissCutie.utils.kbhelpers import ikb


@Bot.on_message(command("blacklist") & filters.group)
...
@Bot.on_message(command("addblacklist") & restrict_filter)
...
@Bot.on_callback_query(filters.regex("^rm_allblacklist$"))
