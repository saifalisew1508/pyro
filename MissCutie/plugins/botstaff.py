...
from MissCutie import DEV_USERS, LOGGER, OWNER_ID, SUDO_USERS, WHITELIST_USERS
...
@Bot.on_message(command("botstaff", dev_cmd=True))
async def botstaff(c: Bot, m: Message):
    try:
