...
from MissCutie import HELP_COMMANDS, LOGGER, SUPPORT_GROUP
from MissCutie.bot_class import Bot
from MissCutie.database.chats_db import Chats
from MissCutie.database.notes_db import Notes
...
from MissCutie.utils.msg_types import Types
...
async def get_private_note(c: Bot, m: Message, help_option: str):
